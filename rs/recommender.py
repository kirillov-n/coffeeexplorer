...
cols_to_replace = ['veg_positions', 'alt_brewing', 'alt_milk', 'small_pets', 'big_pets', 'food', 'non_coffee_drink', 'decaf', 'wifi',
                   'place_for_work', 'specialty_coffee']
...
X = feature_cols
X = X[['avg_bill', 'veg_positions', 'alt_brewing', 'alt_milk', 'small_pets', 'big_pets', 'food', 'non_coffee_drink', 'decaf', 'wifi', 'place_for_work', 'specialty_coffee']]
