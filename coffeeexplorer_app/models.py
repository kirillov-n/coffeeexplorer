...
class Establishments(models.Model):
    ...
    picture = models.ImageField(verbose_name="Изображение", upload_to="establishments", default="establishments/default.jpg")
    ...
    small_pets = models.BooleanField(verbose_name="Наличие возможности посетить с маленькой собакой")
    big_pets = models.BooleanField(verbose_name="Наличие возможности посетить с большой собакой")
